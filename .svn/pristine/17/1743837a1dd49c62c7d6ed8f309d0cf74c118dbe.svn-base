...
{
    public class BD_BQC_Structure: SPImageStructure
    {
        public BD_BQC_Structure(String lNameStr)
       {
           ...
           {
               this.DATA_BLOCK_LIST.Add(new BD_BQC_DataBlock(SPImageGlobal.START_POINT_X_BD + 3 * SPImageGlobal.BD_HEAD_BB_WIDTH,
