...
{
   public class BD_ZJQ_Structure: SPImageStructure
    {
       public BD_ZJQ_Structure(String lNameStr)
       {
           ...
           {
               this.DATA_BLOCK_LIST.Add(new BD_ZJQ_DataBlock(SPImageGlobal.START_POINT_X_BD + 3 * SPImageGlobal.BD_HEAD_BB_WIDTH,
