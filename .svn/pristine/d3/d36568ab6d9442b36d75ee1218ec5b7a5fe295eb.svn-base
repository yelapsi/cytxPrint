...
namespace Maticsoft.Common.model
{
	...
	public partial class lottery_order
	{
        ...
        public lottery_order(Body1000Response body)
        {
            this.userid = body.tickets[0].userid;
            this.license_id = body.licenseId;
            this.id = body.orderId;
            this.total_money = body.totalMoney;
            this.total_tickets_num = body.totalTicketsNum;
            this.userid = body.tickets[0].userid;
            this.username = body.tickets[0].username;
            this.storeid = body.tickets[0].storeid;
            this.stop_time = body.stopTime;

            this.canceled_num = 0;
            this.errticket_num = 0;
            this.ticket_money = 0;
            this.ticket_num = 0;
        }
		#region Model
        ...
        private Int64 _err_ticket_sign_num = 0;
        ...
        private Int64 _expired_num;
        private Int64 _expired_money;
		...
		///  处理进度(暂存进度)
		/// </summary>
        public Int64 err_ticket_sign_num
		{
            set { _err_ticket_sign_num = value; }
            get { return _err_ticket_sign_num; }
		}
		/// <summary>
		/// 
		/// </summary>
        ...
        public Int64 expired_num
        {
            get { return _expired_num; }
            set { _expired_num = value; }
        }

        public Int64 expired_money
        {
            get { return _expired_money; }
            set { _expired_money = value; }
        }
