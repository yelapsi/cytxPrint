...
{
    public class BD_BF_Structure: SPImageStructure
    {
        public BD_BF_Structure(String lNameStr)
       {
           ...
           {
               this.DATA_BLOCK_LIST.Add(new BD_BF_DataBlock(SPImageGlobal.START_POINT_X_BD,
                               SPImageGlobal.START_POINT_Y + (i * 5 + 1) * SPImageGlobal.BD_BB_HIGH_SHORT));
           }

           //过关方式
           this.DATA_BLOCK_LIST.Add(new BD_GGFS_DataBlock(SPImageGlobal.START_POINT_X_BD + 6 * SPImageGlobal.BDBF_HEAD_BB_WIDTH,
                               SPImageGlobal.START_POINT_Y + 16 * SPImageGlobal.BD_BB_HIGH_SHORT, lNameStr));
            //倍数块
           this.DATA_BLOCK_LIST.Add(new MultipleDataBlock(SPImageGlobal.START_POINT_X_BD,
                                SPImageGlobal.START_POINT_Y + 16 * SPImageGlobal.BD_BB_HIGH_SHORT));
        }
