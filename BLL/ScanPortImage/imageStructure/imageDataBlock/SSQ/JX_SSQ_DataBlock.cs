...
{
   public class JX_SSQ_DataBlock: ImageDataBlock
    {
        public static int DATA_BLOCK_HIGH = 5 * SPImageGlobal.BD_BB_HIGH_SHORT;

        public JX_SSQ_DataBlock(int startx, int starty)
       {
       ...
       public override void getPointArrayByData(List<Point> pointlist, String data)
        {            
            ...
            this.getBDRacePoints(pointlist, data, SSQPlayType.DS, this.startPoint);//取赛事的点
